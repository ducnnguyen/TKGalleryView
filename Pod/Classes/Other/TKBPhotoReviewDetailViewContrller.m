...
#import "ReviewCellModel.h"
#import "PhotoReview.h"
#define SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(v)  ([[[UIDevice currentDevice] systemVersion] compare:v options:NSNumericSearch] != NSOrderedAscending)

@interface TKBPhotoReviewDetailViewContrller () {
...
@implementation TKBPhotoReviewDetailViewContrller
...
- (void)viewDidLoad {
    ...
    [self.contentView setDidReply:^(NSInteger index, PhotoReview *photoReview) {
        @strongify(self);
        UINavigationController *navigationController = [[UIStoryboard productPageStoryboard] instantiateViewControllerWithIdentifier:@"ReplyAReviewViewController"];
        ReplyAReviewViewController *controller = (ReplyAReviewViewController*)(navigationController.topViewController);
        ReviewCellModel *cellModel = [[ReviewCellModel alloc] initWithReview:photoReview.review];
        controller.viewModel = cellModel;
